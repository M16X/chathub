          ...
          >
            ...
            >
              <div
                ...
                className="aui-mermaid-zoom-content flex h-full w-full items-center justify-center [&_svg]:mx-auto [&_svg]:h-auto [&_svg]:max-h-[80vh] [&_svg]:max-w-[90vw]"
                style={{
  ...
  return (
    <MermaidZoom svg={result.svg}>
      <div
        ...
        className="aui-mermaid-diagram bg-muted rounded-b-lg p-2 [&_svg]:mx-auto [&_svg]:h-auto [&_svg]:max-w-full"
