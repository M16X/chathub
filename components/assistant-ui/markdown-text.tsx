  ...
  return (
    <StreamdownTextPrimitive
      ...
      componentsByLanguage={{
        ...
        mmd: { SyntaxHighlighter: MermaidDiagram },
      }}
      defer
    />
  );
...
const CodeHeader: FC<CodeHeaderProps> = ({ language, code }) => {
  ...
  return (
    <div className="aui-code-header-root border-border/50 bg-muted/50 mt-3 flex items-center justify-between rounded-t-xl border border-b-0 px-3.5 py-1.5 text-xs mb-0">
